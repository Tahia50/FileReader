...
- (void)setDataSource:(id<DOPDropDownMenuDataSource>)dataSource {
    ...
    for (int i = 0; i < _numOfMenu; i++) {
        ...
        //title
        CGPoint titlePosition = CGPointMake(30.f, self.frame.size.height / 2);
        ...
        //indicator
        CAShapeLayer *indicator = [self createIndicatorWithColor:self.indicatorColor andPosition:CGPointMake(self.frame.size.width - 20.f, self.frame.size.height / 2)];
...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    self = [self initWithFrame:CGRectMake(origin.x, origin.y, 250.f, height)];
    if (self) {
        _origin = origin;
        ...
        //tableView init
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(origin.x, self.frame.origin.y + self.frame.size.height, 250.f, 0) style:UITableViewStylePlain];
        ...
        /*_backGroundView = [[UIView alloc] initWithFrame:CGRectMake(origin.x, origin.y, 250.f, screenSize.height)];
        ...
        //add top shadow
        UIView *topShadow = [[UIView alloc] initWithFrame:CGRectMake(0.f, 0.0f, 250.f, 0.5f)];
        topShadow.backgroundColor = [UIColor lightGrayColor];
        [self addSubview:topShadow];
        UIView *bottomShadow = [[UIView alloc] initWithFrame:CGRectMake(0.f, self.frame.size.height, 250.f, 0.5f)];
        bottomShadow.backgroundColor = [UIColor lightGrayColor];
        [self addSubview:bottomShadow];
        UIView *leftShadow = [[UIView alloc] initWithFrame:CGRectMake(-0.5f, 0.f, 0.5f, 40.f)];
        leftShadow.backgroundColor = [UIColor lightGrayColor];
        [self addSubview:leftShadow];
        UIView *rightShadow = [[UIView alloc] initWithFrame:CGRectMake(self.frame.size.width, 0.f , 0.5f, 40.f)];
        rightShadow.backgroundColor = [UIColor lightGrayColor];
...
- (void)animateBackGroundView:(UIView *)view show:(BOOL)show complete:(void(^)())complete {
    if (show) {
        ...
        [UIView animateWithDuration:0.2 animations:^{
            view.backgroundColor = [UIColor whiteColor];//[UIColor colorWithWhite:0.0 alpha:0.3];
        }];
    } else {
        [UIView animateWithDuration:0.2 animations:^{
...
- (void)confiMenuWithSelectRow:(NSInteger)row {
    ...
    indicator.position = CGPointMake(self.frame.size.width-20.f, indicator.position.y);
}
